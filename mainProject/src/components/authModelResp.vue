<template>
  ...
  export default {
      ...
      async saveInfo(){
        try{
      await api.post('/changeInfoRespR', {
        id:this.user.id_Resp,
        currentMdps:this.currentMdps,
        nom_Resp:this.infoEtud.nom_Resp,
        pre_Resp:this.infoEtud.pre_Resp,
        nom_Entreprise: this.infoEtud.nom_Entreprise,
        telEntreprise: this.infoEtud.telEntreprise,
        addr_Entreprise:this.infoEtud.addr_Entreprise,
